...
Patient add_patient_record(string assigned_id){
 ...
 p1.Person::add_record(assigned_id);
    ...
    if(p1.isAdmitted){
        ...
        p1.patient_bill.bedCost=1000;
        p1.patient_bill.oxygen_cylinder_cost=(p1.oxygen_cylinder_required)?1500:0;
        p1.patient_bill.ventilator_cost=(p1.ventilator_required)?5000:0;
    }
    generateBill(p1);
    return p1;
}
